...
<body>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom01" value="WOUTxxxxxxxxx" required>
  ...
  <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="validationCustom02" value="2019-08-02" required>
    <div class="valid-feedback">
      Looks good!
    </div>
  </div>
